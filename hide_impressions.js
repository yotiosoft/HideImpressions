...
function hide_element_if_grandparent_and_parent_and_child(grandparent_class_name, parent_class_name, class_name) {
  var elements = document.body.getElementsByClassName(class_name);
  ...
  for (var element of elements) {
    ...
    if (parent.className == parent_class_name) {
      ...
      if (grandparent.className == grandparent_class_name) {
        element.style.display = "none";
      }
    }
  }
...
function onRun() {
  ...
  // ver.1.5
  hide_element_if_grandparent_and_parent_and_child("css-146c3p1 r-bcqeeo r-1ttztb7 r-qvutc0 r-1tl8opc r-a023e6 r-rjixqe r-16dba41", "css-1jxf684 r-bcqeeo r-1ttztb7 r-qvutc0 r-1tl8opc", "css-175oi2r r-xoduu5 r-1udh08x");
  hide_element_if_grandparent_and_parent_and_child("css-146c3p1 r-bcqeeo r-1ttztb7 r-qvutc0 r-1tl8opc r-a023e6 r-rjixqe r-16dba41", "css-1jxf684 r-bcqeeo r-1ttztb7 r-qvutc0 r-1tl8opc", "css-1jxf684 r-bcqeeo r-1ttztb7 r-qvutc0 r-1tl8opc r-1b43r93 r-1cwl3u0");
  ...
  hide_element_if_parent_and_child("css-146c3p1 r-bcqeeo r-1ttztb7 r-qvutc0 r-1tl8opc r-a023e6 r-rjixqe r-16dba41 r-1q142lx r-n7gxbd", "css-175oi2r r-xoduu5 r-1udh08x");
}
